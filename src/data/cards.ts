...
const rogueCards: Card[] = [
  ...
  },
  {
    ...
    rarity: "common",
    aggro: 2,
    description: "Deal 4 damage and apply 2 Poison for 2 turns.",
    effects: [
  ...
  },
  {
    ...
    rarity: "common",
    aggro: 2,
    description: "Deal 6 damage twice to a monster.",
    effects: [
      { type: "damage", value: 6, target: "monster" },
      { type: "damage", value: 6, target: "monster" },
    ],
...
const paladinCards: Card[] = [
  ...
  },
  {
    ...
    effects: [{ type: "heal", value: 10, target: "ally" }],
  },
  {
    id: "paladin-24",
    ...
    rarity: "common",
    aggro: 2,
    description: "Give an ally 6 shield.",
    effects: [{ type: "shield", value: 6, target: "ally" }],
  },
  {
    id: "paladin-25",
    name: "Smite Evil",
    ...
    rarity: "common",
    aggro: 3,
    description: "Deal 6 damage and heal self for 4.",
    effects: [
      { type: "damage", value: 6, target: "monster" },
...
const mageCards: Card[] = [
  ...
  },
  {
    ...
    rarity: "common",
    aggro: 2,
    description: "Deal 5 damage and apply 2 Burn for 2 turns.",
    effects: [
      { type: "damage", value: 5, target: "monster" },
  ...
  },
  {
    ...
    rarity: "common",
    aggro: 2,
    description: "Deal 5 damage and apply 2 Ice for 2 turns.",
    effects: [
      { type: "damage", value: 5, target: "monster" },
      { type: "ice", value: 2, target: "monster", duration: 2 },
    ],
...
const priestCards: Card[] = [
  ...
  },
  {
    ...
    rarity: "common",
    aggro: 2,
    description: "Deal 6 damage to a monster.",
  ...
  },
  {
    ...
    rarity: "common",
    aggro: 2,
    description: "Deal 7 damage and heal self for 3.",
    effects: [
